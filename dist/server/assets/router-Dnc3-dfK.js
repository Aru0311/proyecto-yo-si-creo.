...
const logoPlaceholder = "/assets/yosicreo-DAJwVPIP.jpg";
const nav = [
  { to: "/", label: "Inicio" },
...
function SiteHeader() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "sticky top-0 z-50 backdrop-blur-md bg-background/70 border-b border-border/60", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6 h-16 flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex items-center gap-3 group", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative flex h-14 w-14 items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
            src: logoPlaceholder,
            alt: "Yo Sí Creo Logo",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "leading-tight", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block font-serif text-lg text-foreground", children: "Yo Sí Creo" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-[10px] uppercase tracking-[0.2em] text-muted-foreground", children: "en Venezuela · Punto Fijo" })
        ] })
      ] }),
...
function SiteFooter() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "border-t border-border/60 bg-background mt-24", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flag-stripe h-1 w-full", "aria-hidden": true }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6 py-14 grid gap-10 md:grid-cols-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-serif text-2xl text-foreground", children: "Yo Sí Creo en Venezuela" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-sm text-muted-foreground max-w-md", children: "Línea de taxi al servicio de Punto Fijo y la Península de Paraguaná. Conducimos con orgullo, puntualidad y esperanza." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs uppercase tracking-widest text-gold mb-3", children: "Navegación" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-2 text-sm text-muted-foreground", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/tarifas", className: "hover:text-foreground", children: "Tarifas" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/cobertura", className: "hover:text-foreground", children: "Cobertura" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/seguridad", className: "hover:text-foreground", children: "Seguridad" }) }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs uppercase tracking-widest text-gold mb-3", children: "Central 24/7" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-2 text-sm text-muted-foreground", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Tel: +58 269 123 4567" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "WhatsApp: +58 414 555 0123" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Av. Bolívar, Punto Fijo, Falcón" })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-border/60 py-5 text-center text-xs text-muted-foreground", children: [
      ...
      " Línea Yo Sí Creo en Venezuela · RIF J-502439935"
    ] })
  ] });
}
const appCss = "/assets/styles-BcqAPw3G.css";
function NotFoundComponent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center bg-background px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-serif text-7xl text-gold", children: "404" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", className: "inline-flex items-center justify-center rounded-full bg-gold px-5 py-2.5 text-sm font-semibold text-gold-foreground hover:brightness-110 transition", children: "Volver al inicio" }) })
  ] }) });
}
...
const $$splitComponentImporter$4 = () => import("./tarifas-BEpFucOj.js");
const Route$4 = createFileRoute("/tarifas")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Tarifas oficiales con taxímetro digital, recargos y horarios de servicio en Punto Fijo, Falcón."
    }]
  })
});
const $$splitComponentImporter$3 = () => import("./seguridad-atDxj3je.js");
const Route$3 = createFileRoute("/seguridad")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Protocolos de seguridad para usuarios: identificación de unidades, GPS, contacto de emergencia y atención de quejas."
    }]
  })
});
const $$splitComponentImporter$2 = () => import("./contacto-DFMERNy9.js");
const Route$2 = createFileRoute("/contacto")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Comunícate con la central de despacho 24/7 en Punto Fijo, Falcón."
    }]
  })
});
const $$splitComponentImporter$1 = () => import("./cobertura-DGXaLdyW.js");
const Route$1 = createFileRoute("/cobertura")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Cobertura local en Punto Fijo y la Península de Paraguaná, y servicios nacionales a las principales ciudades de Venezuela."
    }, {
      property: "og:image",
      content: "/src/assets/coverage.jpg"
    }]
  })
});
const $$splitComponentImporter = () => import("./index-DA9GOR1q.js");
const Route2 = createFileRoute("/")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Servicio de taxi 24/7 en Punto Fijo y la Península de Paraguaná. Choferes verificados, taxímetro digital y tarifas justas."
    }]
  })
});
const TarifasRoute = Route$4.update({
  id: "/tarifas",
  path: "/tarifas",
  getParentRoute: () => Route$5
});
const SeguridadRoute = Route$3.update({
  id: "/seguridad",
  path: "/seguridad",
  getParentRoute: () => Route$5
});
...
const CoberturaRoute = Route$1.update({
  id: "/cobertura",
  path: "/cobertura",
  getParentRoute: () => Route$5
});
